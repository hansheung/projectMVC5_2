              ...
              <div class="modal-dialog"> \
                <div class="modal-content"> \
                  <div class="modal-header"> \
                    ...
                    <h1 class="modal-title">' + opt.title + '</h1> \ //===Modify by Hans to make it bigger
                  </div> \
                  ...
                  <div class="modal-footer"> \
                    ...
                    <button id="session-timeout-dialog-keepalive" type="button" class="btn btn-primary" style="width:200px" data-dismiss="modal">' + opt.keepAliveButton + '</button> \
                  </div> \
                </div> \
              </div> \
             </div>');
